# Django settings for keyuatest project.
import os.path
...
ADMINS = (
    ('Igor Bestuzhev', 'best.igor@gmail.com'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = os.path.join(BASE_PATH,'key.db')            # Or path to database file if using sqlite3.
...
SECRET_KEY = 'f=utk^a82-++q+hnjt2_++mr*yq$1**me^%=mk_3f!5vf50+8j'
